        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall title="Actualizar contraseña" description="Asegúrate de que la contraseña de tu cuenta contiene minúsculas, mayúsculas, números y algún carácter especial para que tu cuenta esté más segura" />
