        ...
        <AppLayout>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <p className="text-muted-foreground text-sm">
                    Gastronomía, recetas, costumbres culinarias, etc... la cocina y sus productos en la emisión en directo del canal
                    Cocina.
                </p>
                <div className="flex justify-center">
                    <div className="w-3/6 max-w-4xl">
                        <iframe
                            ...
                            allowFullScreen
                            className="hover:shadow-primary hover:ring-primary/60 aspect-video w-full transform-gpu cursor-pointer rounded-xl shadow-lg transition-all duration-1000 hover:[transform:scale(1.05)] hover:shadow-[0_0_30px_8px]"
                        />
                    </div>
                </div>
                ...
                <p className="text-muted-foreground text-sm">
                    Descubre nuestra Playlist Healthy de Youtube: consejos nutricionales, charlas sobre alimentación, recetas saludables, etc...
                </p>
                <div className="flex justify-center">
                    <div className="w-3/6 max-w-4xl">
                        <YouTube
