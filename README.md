...
- ---> ORDEN DE CREACIÓN
  - Modelo -> Migración (User/Menu/Producto) -> Factoría -> Seeder (Dentro de DatabaseSeeder UserSeeder/MenuSeeder/ProductoSeeder)
...
![1:N con Menu](relaciones-user.png)
...
- ---> Menu
  ...
  2. Relaciones del modelo:
    ...
    ![1:N con User, 1:N con Producto](relaciones-menu.png)
  - Migraciones: Configuramos que nombre tendrá la tabla, y que tipo, nombre y restricciones los campos, todo esto a la hora de lanzar la migración
   
    ![migracion-productos](migracion-productos.png)
...
- ---> Modelo Producto
  - php artisan make:model Producto -m (-m para crear también la migración)
    ...
    ![1:N con Menu](relaciones-producto.png)
